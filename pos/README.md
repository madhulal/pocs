...
5. In another console run the E2E-Tests
  ...
  Start mango db specifying the path --dbpath <root>/data

  To run the server use gradle tomcatRun  at the root of the folder

  open the browser in http://localhost:8080/store
